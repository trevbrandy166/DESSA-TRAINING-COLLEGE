...
// //       );
// //       programs.forEach((p) => insert.run(p));
// //       insert.finalize();
...
//     // Check if programs exist and insert sample data
//     db.get("SELECT COUNT(*) as count FROM programs", (err, row) => {
//       if (err) {
...
//     // NEW: Applications table (full admissions)
//     db.run(`
